...
export default class extends BaseSeeder {
  public async run () {
    ...
    await Post.createMany([
      ...
      {
        slug: "dzanan-musa-bez-promasene-trojke",
        title: "Dzanan Musa bez promasene trojke",
        description: "Dzanan Musa ubacio 20 poena, 6/6 za tri poena",
        body: "Dzanan je na terenu proveo 27 minute u kojima je dao ogroman doprinos pobjedi. Ukupno je ubacio 20 poena.",
      },
